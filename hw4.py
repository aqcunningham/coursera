# import json, sys
# sys.path.insert(1, r'/home/coder/project/employee.py')
# # import employee
# # from employee impcoort employee_name, age, title, details
...
# def write_json_to_file(json_obj, output_file, dict):
...
#     # print(json_obj)
#     # output_file = json.dumps(json_obj)
#     with open(output_file, 'w') as newfile:
#         newfile.writelines(json_obj)
#         close()
