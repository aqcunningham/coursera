...
def generate_usernames(mod_list):
   ...
   [IMPLEMENT ME] 
      ...
      list = [mod_list.replace(" ", "z") for x in mod_list]
   ...
   """
   ### WRITE SOLUTION CODE HERE
   # x is a var within iteration
   # comprehensions eliminates the use of explicit loops
...
def map_id_to_initial(employee_list):
   ...
   # while tried using different variations of looping, eventually just needed to put the path to key and its value for the given list.
   # again, using x as an internal var in comprehension
   return dict
   raise NotImplementedError()
